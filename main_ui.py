...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 40, 781, 401))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_6.setText(_translate("MainWindow", "Borrar VM", None))
        self.pushButton_5.setText(_translate("MainWindow", "Iniciar VM", None))
        self.pushButton_4.setText(_translate("MainWindow", "Parar VM", None))
        self.pushButton_3.setText(_translate("MainWindow", "Mostrar VM", None))
